sap.ui.define([
    ...
    return {
        ...
        onAfterItemAdded: async function (oEvent) {
            ...
            //                 var postResponse = {
            //                     url: "https://port4004-workspaces-ws-9bd5s.us10.trial.applicationstudio.cloud.sap/media/purchaseRequestd(ID=${sHeaderId},IsActiveEntity=true)/_Attachments",
            //                 method: 'POST',
            //                 headers: {
            ...
            //             const putResponse =  await fetch(`${sServiceUrl}purchaseRequestd(ID=${sHeaderId},IsActiveEntity=true)/_Attachments(UUID=${mediaId},IsActiveEntity=false)/content`, {
            //                 method: 'PUT',
